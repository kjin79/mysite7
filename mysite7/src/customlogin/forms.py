...
class SignupForm(forms.ModelForm):
    ...
    #forms.xxxField : 폼클래스에 사용자 입력공간을 정의할 때 사용함
    #모델클래스에서 사용한 models.xxxField와 기능과 이름이 유사함
    #label 매개변수 : 해당 입력공간의 설명란을 정의하는 매개변수, 기본값은 변수명을 설정됨
    
    #위젯 : 데이터저정형식 외에 사용자의 입력타입을 변환하는 것
    #비밀번호 작성란은 텍스트값을 입력받기 때문에 type=text로 되어있지만
